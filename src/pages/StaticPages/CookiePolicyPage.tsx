...
const CookiePolicyPage = (props: any) => {
  const { content } = props;

  const cookiePolicyData = useSelector<any, any>(
    makeSelector(['staticPagesReducer', 'cookiePolicyData']),
  );
  ...
  return (
    ...
    <div className="terms-of-service-wrapper static-page ql-editor">
      <div
        dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(cookiePolicyData) }}
      />

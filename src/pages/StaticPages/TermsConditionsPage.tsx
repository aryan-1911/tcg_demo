...
const TermsConditionsPage = (props: any) => {
  ...
  const termsAndConditionsData = useSelector<any, any>(
    makeSelector(['staticPagesReducer', 'termsAndConditionsData']),
  );
  ...
  return (
    ...
    <div className="terms-of-service-wrapper static-page ql-editor">
        <div
          dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(termsAndConditionsData) }}
          />
